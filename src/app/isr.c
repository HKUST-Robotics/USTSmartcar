...
int turn_kp_array[5]              = {75000         , 75000       , 50000        , 36825   , 0};  // 愈細 = 遲入灣 ; 愈大 = 早入灣 , mode 3 : 98800 mode 1 : 120500
int turn_kd_array[5]              = {0             , 32500       , 18500        , 11250    , 0}; 
int turn_offset_array[5]          = {1250          , 1250        , 1250         , 1250    , 0};  // 愈細 = 中心線靠右 ; 愈大 = 中心線靠左  
float atan_multiply_value_array[5]= {0.0069808027  ,0.00698080279, 0.00858080279, 0.01   , 0};
