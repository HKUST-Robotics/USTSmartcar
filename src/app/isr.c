...
int turn_kp_array[5]            = {120500 , 92500  , 72600   , 115000  , 0};  // 愈細 = 遲入灣 ; 愈大 = 早入灣 , mode 3 : 98800 mode 1 : 120500
int turn_kd_array[5]            = {100000 , 42500  , 35000   , 100     , 0}; 
...
int run_speed_mode = 1;         /*** vaild input : 0 - 4; Refer mode 0: 300 ; mode 1: 600 ; mode 2: 900 ; mode 3: 1200 ; mode 4: 1500***/
